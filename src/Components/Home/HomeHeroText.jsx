...
const HomeHeroText = () => {
  ...
  <div  className='font-[font1] text-white mt-72 lg:mt-0 pt-5 text-center'>
    ...
    <div className='lg:text-[9vw] text-[12vw] justify-center flex items-center uppercase lg:leading-[8vw] leading-[10vw]'>
            ...
            <p className='flex text-center flex-col absolute pl-6 ml-4  w-64 mr-4 right-0 bottom-24  lg:bottom-72 font-[font1] lg:text-lg text-xs lg:leading-relaxed leading-tight'>
